...
void GRResetPenAndBrush( QPainter* DC );
void GRSetColorPen(QPainter* DC, const COLOR4D& Color, int width = 1,
                    wxPenStyle stype = wxPENSTYLE_SOLID );
void GRSetBrush(QPainter* DC, const COLOR4D& Color, bool fill = false );
