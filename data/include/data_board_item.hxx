...
public:
    ...
    {
        constexpr int mask =
                (CANDIDATE | SELECTED_BY_DRAG | IS_LINKED | SKIP_STRUCT | SELECTION_CANDIDATE | CONNECTIVITY_CANDIDATE);
